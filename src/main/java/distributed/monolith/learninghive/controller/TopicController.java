...
import distributed.monolith.learninghive.service.LearnedTopicService;
...
public class TopicController {
	...
	public void deleteLearnedTopic(@RequestParam("id") Long id) {
		learnedTopicService.deleteLearnedTopic(id, securityService.getLoggedUserId());
	}
	...
	public LearnedTopicsResponse getLearnedTopics(
		...
		return learnedTopicService.findLearnedTopics(userId == null ? securityService.getLoggedUserId() : userId);
	}
}
